"""Run the bundled MSFT reverse DCF case study."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        default="data/sample_inputs/msft.json",
        help="Manual fallback input path.",
    )
    parser.add_argument(
        "--output",
        default="reports/msft_reverse_dcf_report.md",
        help="Markdown report output path.",
    )
    parser.add_argument("--revenue-cagr", type=float, default=0.12)
